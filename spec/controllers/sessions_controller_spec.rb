  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved session as @session" do
        ...
        post :create, {:session => { "title" => "invalid value" }}, valid_session
        assigns(:session).should be_a_new(Session)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested session" do
        ...
        Session.any_instance.should_receive(:update).with({ "title" => "MyString" })
        put :update, {:id => session.to_param, :session => { "title" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the session as @session" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Session.any_instance.stub(:save).and_return(false)
        put :update, {:id => session.to_param, :session => { "title" => "invalid value" }}, valid_session
        assigns(:session).should eq(session)
      end
